...
import org.apache.servicemix.grid.agent.smx4.ServiceMixAgent;
import org.apache.servicemix.grid.agent.FeatureList;
...
public class ServiceMixAgentTest extends TestCase {
    ...
    class MockFeaturesService implements FeaturesService {
        ...
        public void installFeature(String name) throws Exception {
            ...
            org.apache.servicemix.grid.agent.Feature f = lastFeatureList.getFeature(name);
            assertNotNull(f);
